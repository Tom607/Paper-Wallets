...
crypt_multi_font_family = typeof crypt_multi_font_family == "undefined" ? "Apercu Mono" : crypt_multi_font_family;
crypt_multi_font_size = typeof crypt_multi_font_size == "undefined" ? "normal" : crypt_multi_font_size;
crypt_multi_font_color = typeof crypt_multi_font_color == "undefined" ? "#555" : crypt_multi_font_color;
crypt_multi_display_time = typeof crypt_multi_display_time == "undefined" ? false : crypt_multi_display_time;
...
document.write('\
    <div class="cryptonatorwidget" style="border-radius:0px;' + crypt_multi_style + '">\
    ');
...
for (var i = 0; i < crypt_multi_num_cur; ++i) {
  ...
  if (getPar.success != false) {
    ...
    var text_style = '<font style="color:#cc0000;font-weight:normal;"><b>&darr;</b></font>';
    if (getPar.ticker.change >= 0) {
      text_style = '<font style="color:#009900;font-weight:normal;"><b>&uarr;</b></font>';
    }

    document.write('<div style="border-bottom: 0px solid ' + crypt_multi_border_color + ';padding:0px;">\
            <font style="font-size:90%;">' + n1 + '</font>\
            ' + price + ' ' + n2.match(/.*?\(([0-9a-z]+)\)/i)[1] + '\
                ' + '\
                ');
    ...
    document.write('<div style="border-bottom: 0px solid ' + crypt_multi_border_color + ';padding:10px;">No price available</div>');
  }
}
